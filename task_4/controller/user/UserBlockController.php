...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        foreach ($ids as $id) {
            ...
            if ($id <= 0) {
                ...
                updateUserStatus('blocked', $id);
                // Add Log
                $log_inserted_id = createLog("block : ".$id, $current_date_time, $user_id);
                // Deleting Session
                if($id === $user_id){
                    $_SESSION['user_id'] = -1;
                }
        ...
        $errorMessage = urldecode("Blocked successfully");
    ...
    $error_location = "UserBlockController";
