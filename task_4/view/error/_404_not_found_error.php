...
require_once $_SERVER['DOCUMENT_ROOT'] . $PROJECT_ROOT. '/itransition/routes.php';
require_once $_SERVER['DOCUMENT_ROOT'] . $PROJECT_ROOT. '/itransition/utility_functions.php';
