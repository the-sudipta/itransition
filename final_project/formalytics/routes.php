...
$routes = [
    ...
    'user_my_profile' => $PROJECT_ROUTE . '/view/user/My_Profile.php',
    'analytics' => $PROJECT_ROUTE . '/view/user/User_Analytics.php',
...
//    General Controllers
    ...
    'my_profile_controller' => $PROJECT_ROUTE . '/controller/user/my_profile/My_ProfileController.php',
    'api_controller' => $PROJECT_ROUTE . '/controller/user/my_profile/ApiController.php',
...
$image_routes = [
    ...
    'logo_with_background' => $PROJECT_ROUTE . '/view/static/image/formalytics_logo_with_background.png',
    'logo' => $PROJECT_ROUTE . '/view/static/image/formalytics_logo.png',
    'logo_icon' => $PROJECT_ROUTE . '/view/static/image/formalytics_logo.ico',
